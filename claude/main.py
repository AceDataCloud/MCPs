...
Claude models through the AceDataCloud platform.
"""
                        ...
                        "tools": [
                            {
                                ...
                                "description": "Create chat completions using Claude models (OpenAI-compatible)",
                            },
                            {
                                "name": "claude_messages",
                                "description": "Create messages using the native Anthropic messages API",
                            },
                            {
