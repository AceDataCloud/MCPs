...
MCP (Model Context Protocol) server for Claude API via AceDataCloud.
...
tools/
  tools/chat_tools.py  — claude_chat_completion, claude_create_message
...
1. **Source of truth** — `_docs/openapi/claude.json` is the OpenAPI spec for the Claude API.
