...
from core.exceptions import ClaudeAPIError, ClaudeAuthError, ClaudeTimeoutError


@pytest.fixture
def client():
    """Create a client instance for testing."""
    return ClaudeClient(api_token="test-token", base_url="https://api.test.com")
...
class TestClaudeClient:
    ...
    def test_init_with_params(self):
        ...
        client = ClaudeClient(api_token="my-token", base_url="https://custom.api.com")
    ...
    def test_get_headers_no_token(self):
        ...
        client = ClaudeClient(api_token="", base_url="https://api.test.com")
        with pytest.raises(ClaudeAuthError, match="not configured"):
            client._get_headers()
    ...
    async def test_request_auth_error_401(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(ClaudeAuthError, match="Invalid API token"):
    ...
    async def test_request_http_error(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(ClaudeAPIError, match="Internal Server Error") as exc_info:
                await client.request("/v1/chat/completions", {})
    ...
    @pytest.mark.asyncio
    async def test_create_message_method(self, client, mock_chat_response):
        """Test the create_message convenience method."""
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = mock_chat_response
