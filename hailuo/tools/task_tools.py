"""Task query tools for Hailuo API."""
...
@mcp.tool()
async def hailuo_get_task(
    task_id: Annotated[
        str,
        Field(
            description="The task ID returned from a generation request. This is the 'task_id' field from any hailuo_generate_* tool response."
        ),
    ],
) -> str:
