...
MCP (Model Context Protocol) server for Hailuo (MiniMax) AI video generation via AceDataCloud API.
...
core/
  ...
  types.py      — Literal types (HailuoModel, etc.)
...
1. **Source of truth** — `_docs/openapi/hailuo.json` is the OpenAPI spec for the HailuoMCP API.
