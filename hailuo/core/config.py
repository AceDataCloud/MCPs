"""Configuration management for MCP Hailuo server."""
...
class Settings:
    ...
    default_model: str = field(
        default_factory=lambda: os.getenv("HAILUO_DEFAULT_MODEL", "minimax-t2v")
    )

    # Request Configuration
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("HAILUO_REQUEST_TIMEOUT", "1800"))
    )

    # Server Configuration
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "hailuo"))
