...
class HailuoClient:
    """Async HTTP client for AceDataCloud Hailuo API."""

    def __init__(self, api_token: str | None = None, base_url: str | None = None):
        """Initialize the Hailuo API client.
        ...
        logger.info(f"HailuoClient initialized with base_url: {self.base_url}")
    ...
    async def request(
        ...
        Args:
            endpoint: API endpoint path (e.g., "/hailuo/videos")
        ...
        Raises:
            HailuoAuthError: If authentication fails
            HailuoAPIError: If the API request fails
            HailuoTimeoutError: If the request times out
        """
