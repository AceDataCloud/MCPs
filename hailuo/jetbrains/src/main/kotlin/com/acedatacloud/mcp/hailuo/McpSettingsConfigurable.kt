...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Hailuo MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/hailuo")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/HailuoMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-hailuo/")
                }
            }
        }
