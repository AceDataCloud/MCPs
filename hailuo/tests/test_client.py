...
from core.exceptions import HailuoAPIError, HailuoAuthError, HailuoTimeoutError


@pytest.fixture
def client():
    """Create a client instance for testing."""
    return HailuoClient(api_token="test-token", base_url="https://api.test.com")


class TestHailuoClient:
    """Tests for HailuoClient class."""

    def test_init_with_params(self):
        """Test client initialization with explicit parameters."""
        client = HailuoClient(api_token="my-token", base_url="https://custom.api.com")
    ...
    def test_get_headers_no_token(self):
        ...
        client = HailuoClient(api_token="", base_url="https://api.test.com")
        with pytest.raises(HailuoAuthError, match="not configured"):
            client._get_headers()
    ...
    async def test_request_success(self, client, mock_video_response):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await client.request("/hailuo/videos", {"action": "generate"})
    ...
    async def test_request_auth_error_401(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(HailuoAuthError, match="Invalid API token"):
                await client.request("/hailuo/videos", {})
    ...
    async def test_request_timeout(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(HailuoTimeoutError, match="timed out"):
                await client.request("/hailuo/videos", {})
    ...
    async def test_request_http_error(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(HailuoAPIError, match="Internal Server Error") as exc_info:
                await client.request("/hailuo/videos", {})
