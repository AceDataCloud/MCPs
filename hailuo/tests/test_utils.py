...
class TestFormatVideoResult:
    ...
    def test_format_success(self, mock_video_response):
        ...
        assert data["mcp_async_submission"]["poll_tool"] == "hailuo_get_task"
        assert data["mcp_async_submission"]["batch_poll_tool"] == "hailuo_get_tasks_batch"
...
class TestFormatTaskResult:
    ...
    def test_format_success(self, mock_task_response):
        ...
        assert data["mcp_task_polling"]["poll_tool"] == "hailuo_get_task"
        assert data["mcp_task_polling"]["batch_poll_tool"] == "hailuo_get_tasks_batch"
