...
def test_settings_default_values():
    ...
    with patch.dict(os.environ, {"ACEDATACLOUD_API_TOKEN": "test"}, clear=False):
        ...
        assert settings.default_model == "fish-tts"
        assert settings.request_timeout == 1800.0
        assert settings.server_name == "fish"
...
def test_settings_from_environment():
    ...
    env_vars = {
        ...
        "FISH_DEFAULT_MODEL": "fish-tts",
        "FISH_REQUEST_TIMEOUT": "300",
        "MCP_SERVER_NAME": "my-fish",
        "LOG_LEVEL": "DEBUG",
    }
    ...
    with patch.dict(os.environ, env_vars, clear=False):
        ...
        assert settings.server_name == "my-fish"
