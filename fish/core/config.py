"""Configuration management for MCP Fish server."""
...
class Settings:
    ...
    default_model: str = field(
        default_factory=lambda: os.getenv("FISH_DEFAULT_MODEL", "fish-tts")
    )

    # Request Configuration
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("FISH_REQUEST_TIMEOUT", "1800"))
    )

    # Server Configuration
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "fish"))
