...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Fish Audio MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/fish")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/FishMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-fish/")
                }
            }
        }
