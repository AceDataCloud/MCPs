#!/usr/bin/env python3
"""
MCP Fish Server - Fish TTS (Text-to-Speech) via AceDataCloud API.

A Model Context Protocol (MCP) server that provides tools for generating
speech and cloning voices using the Fish Audio TTS API through AceDataCloud.
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="MCP Fish Server - Fish TTS",
...
Environment Variables:
  ...
  LOG_LEVEL                   Logging level (default: INFO)
    ...
    safe_print("")
    safe_print("=" * 50)
    safe_print("  MCP Fish Server - Fish TTS")
    safe_print("=" * 50)
    safe_print("")
                ...
                return JSONResponse(
                    {
                        ...
                        "tools": [
                            ...
                            },
                            {
                                ...
                                "description": "Clone a voice from an audio sample URL",
                            },
                            {
                                "name": "fish_get_task",
                        ...
                        "prompts": [
                            {"name": "fish_guide", "description": "Fish TTS tool selection guide"},
                            {
                                ...
                                "description": "Example Fish TTS workflows",
                            },
                        ],
                        "resources": [],
                    }
