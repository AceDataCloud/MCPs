...
//
// Registers the hosted Ace Data Cloud "luma" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "luma.apiToken")
...
//   - acedatacloud.luma.setApiToken
//   - acedatacloud.luma.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.luma";
const SERVER_LABEL = "Luma MCP";
const SERVER_URL = "https://luma.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.luma.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.luma.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "luma.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-luma";
