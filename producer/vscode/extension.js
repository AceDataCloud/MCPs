...
//
// Registers the hosted Ace Data Cloud "producer" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "producer.apiToken")
...
//   - acedatacloud.producer.setApiToken
//   - acedatacloud.producer.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.producer";
const SERVER_LABEL = "Producer MCP";
const SERVER_URL = "https://producer.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.producer.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.producer.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "producer.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-producer";
