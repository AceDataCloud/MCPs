"""Task query tools for Producer API."""
...
@mcp.tool()
async def producer_get_task(
    task_id: Annotated[
        str,
        Field(
            description="The task ID returned from a generation request. This is the 'task_id' field from any producer_generate_*, producer_extend_*, producer_cover_*, or other tool response."
        ),
    ],
) -> str:
