...
//
// Registers the hosted Ace Data Cloud "seedance" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "seedance.apiToken")
...
//   - acedatacloud.seedance.setApiToken
//   - acedatacloud.seedance.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.seedance";
const SERVER_LABEL = "Seedance MCP";
const SERVER_URL = "https://seedance.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.seedance.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.seedance.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "seedance.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-seedance";
