...
//
// Registers the hosted Ace Data Cloud "shorturl" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "shorturl.apiToken")
...
//   - acedatacloud.shorturl.setApiToken
//   - acedatacloud.shorturl.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.shorturl";
const SERVER_LABEL = "Short URL MCP";
const SERVER_URL = "https://shorturl.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.shorturl.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.shorturl.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "shorturl.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-shorturl";
