...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Minimax MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/minimax-videos")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/MinimaxMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-minimax/")
                }
            }
        }
