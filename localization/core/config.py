"""Configuration management for MCP Localization server."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("LOCALIZATION_REQUEST_TIMEOUT", "120"))
    )
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "localization"))
