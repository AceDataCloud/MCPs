package com.acedatacloud.mcp.serp
...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Serp MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/serp-mcp")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/SerpMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-serp/")
                }
            }
        }
