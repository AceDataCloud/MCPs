...
2. **Get an API key** from [Ace Data Cloud](https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-serp) (Applications -> API Key). New accounts include free trial credit.
...
From $0.003 per query. Free trial credit on sign-up. See full pricing at [https://platform.acedata.cloud/documents/serp-mcp](https://platform.acedata.cloud/documents/serp-mcp).
...
- **Ace Data Cloud platform:** https://platform.acedata.cloud/?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-serp
- **MCP documentation:** https://platform.acedata.cloud/documents/serp-mcp
