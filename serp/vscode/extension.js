...
//
// Registers the hosted Ace Data Cloud "serp" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "serp.apiToken")
...
//   - acedatacloud.serp.setApiToken
//   - acedatacloud.serp.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.serp";
const SERVER_LABEL = "Serp MCP";
const SERVER_URL = "https://serp.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.serp.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.serp.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "serp.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-serp";
