"""HTTP client for Qwen Image API."""
...
class QwenImageClient:
    """Async HTTP client for AceDataCloud Qwen Image API."""

    def __init__(self, api_token: str | None = None, base_url: str | None = None):
        """Initialize the Qwen Image API client.
        ...
        logger.info(f"QwenImageClient initialized with base_url: {self.base_url}")
    ...
    def _handle_error_response(self, response: httpx.Response) -> None:
        ...
        if status in (401, 403):
            raise QwenImageAuthError(message)
        raise QwenImageAPIError(message=message, code=code, status_code=status)
    ...
    async def request(
        ...
        """Make a POST request to the Qwen Image API.
        ...
        Raises:
            QwenImageAuthError: If authentication fails
            QwenImageAPIError: If the API request fails
            QwenImageTimeoutError: If the request times out
        """
    ...
    async def generate_image(self, **kwargs: Any) -> dict[str, Any]:
        ...
        return await self.request("/qwen-image/images", self._with_async_callback(kwargs))
    ...
    async def query_task(self, **kwargs: Any) -> dict[str, Any]:
        ...
        return await self.request("/qwen-image/tasks", kwargs)
