"""Utility functions for MCP Qwen Image server."""
...
def format_image_result(data: dict[str, Any]) -> str:
    ...
    """
    return json.dumps(
        _with_submission_guidance(data, "qwen_image_get_task", "qwen_image_get_tasks_batch"),
        ensure_ascii=False,
        indent=2,
    )
...
def format_task_result(data: dict[str, Any]) -> str:
    ...
    """
    return json.dumps(
        _with_task_guidance(data, "qwen_image_get_task", "qwen_image_get_tasks_batch"),
        ensure_ascii=False,
        indent=2,
    )
