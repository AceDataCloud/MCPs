...
MCP (Model Context Protocol) server for Qwen Image AI image generation via AceDataCloud API.
...
core/
  ...
  types.py      — Literal types (QwenImageModel, etc.)
...
1. **Source of truth** — `_docs/openapi/qwen-image.json` is the OpenAPI spec for the Qwen ImageMCP API.
