...
2. **Get an API key** from [Ace Data Cloud](https://platform.acedata.cloud/console/platform-tokens?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-acedatacloud) (Platform Tokens -> Create). New accounts include free trial credit.
...
- **Ace Data Cloud platform:** https://platform.acedata.cloud/?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-acedatacloud
