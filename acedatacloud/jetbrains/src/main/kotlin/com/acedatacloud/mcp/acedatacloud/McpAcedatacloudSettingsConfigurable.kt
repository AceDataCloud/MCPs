...
class McpAcedatacloudSettingsConfigurable : Configurable {

    private var myPanel: DialogPanel? = null
    private var apiToken: String = ""

    override fun getDisplayName(): String = "Ace Data Cloud MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
                ...
                group("STDIO (Local)") {
                    ...
                    row {
                        button("Copy STDIO Config") {
                            copyToClipboard(McpAcedatacloudSettings.getInstance().getStdioConfig())
                        }
                    }
                }
                ...
                group("HTTP (Remote)") {
                    ...
                    row {
                        button("Copy HTTP Config") {
                            copyToClipboard(McpAcedatacloudSettings.getInstance().getHttpConfig())
                        }
                    }
                }
            }
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/acedatacloud-mcp")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/AceDataCloudMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-acedatacloud/")
                }
            }
        }
