...
MCP (Model Context Protocol) server for GLM chat completions via AceDataCloud API.
...
tools/
  chat_tools.py  — glm_chat_completions
  info_tools.py  — glm_list_models, glm_get_usage_guide
...
1. **Source of truth** — `_docs/openapi/glm.json` is the OpenAPI spec for the GLM API.
