...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "AiChat MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/aichat")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/AiChatMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-aichat/")
                }
            }
        }
