...
MCP (Model Context Protocol) server for Gemini API via AceDataCloud.
...
tools/
  tools/chat_tools.py  — gemini_chat_completion, gemini_generate_content
...
1. **Source of truth** — `_docs/openapi/gemini.json` is the OpenAPI spec for the Gemini API.
