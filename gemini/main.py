...
Gemini models through the AceDataCloud platform.
"""
                        ...
                        "tools": [
                            {
                                ...
                                "description": "Create chat completions using Gemini models (OpenAI-compatible)",
                            },
                            {
                                "name": "gemini_generate_content",
                                "description": "Generate content using the native Gemini API",
                            },
                            {
