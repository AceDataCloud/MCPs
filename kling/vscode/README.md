...
2. **Get an API key** from [Ace Data Cloud](https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-kling) (Applications -> API Key). New accounts include free trial credit.
...
From $0.20 per 5s clip. Free trial credit on sign-up. See full pricing at [https://platform.acedata.cloud/documents/kling](https://platform.acedata.cloud/documents/kling).
...
- **Ace Data Cloud platform:** https://platform.acedata.cloud/?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-kling
- **MCP documentation:** https://platform.acedata.cloud/documents/kling
