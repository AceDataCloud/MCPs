...
//
// Registers the hosted Ace Data Cloud "kling" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "kling.apiToken")
...
//   - acedatacloud.kling.setApiToken
//   - acedatacloud.kling.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.kling";
const SERVER_LABEL = "Kling MCP";
const SERVER_URL = "https://kling.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.kling.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.kling.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "kling.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-kling";
