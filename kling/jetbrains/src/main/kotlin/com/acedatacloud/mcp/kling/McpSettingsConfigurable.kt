...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Kling MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/kling")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/KlingMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-kling/")
                }
            }
        }
