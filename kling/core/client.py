...
class KlingClient:
    ...
    async def request(
        ...
        Args:
            endpoint: API endpoint path (e.g., "/kling/videos")
        ...
        Raises:
            KlingAuthError: If authentication fails
            KlingAPIError: If the API request fails
            KlingTimeoutError: If the request times out
        """
    ...
    async def query_task(self, **kwargs: Any) -> dict[str, Any]:
        ...
        return await self.request("/kling/tasks", kwargs)
