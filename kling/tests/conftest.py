...
def mock_video_response():
    ...
    return {
        ...
        "video_url": "https://platform.cdn.acedata.cloud/kling/test-task-123.mp4",
        "duration": 5,
        "state": "completed",
    }
...
def mock_motion_response():
    ...
    return {
        "success": True,
        "task_id": "test-motion-123",
        "video_id": "test-motion-video-456",
        "video_url": "https://platform.cdn.acedata.cloud/kling/test-motion-123.mp4",
        "duration": 5,
        "state": "completed",
    }
...
def mock_task_response():
    ...
    return {
        ...
        "response": {
            ...
            "video_id": "video-456",
            "prompt": "A test video",
            "video_url": "https://platform.cdn.acedata.cloud/kling/task-123.mp4",
            "duration": 5,
            "state": "completed",
        },
    }
        ...
        "items": [
            ...
            },
            {
                ...
                "response": {
                    ...
                    "task_id": "task-789",
                    "video_id": "video-012",
                    "video_url": "https://platform.cdn.acedata.cloud/kling/task-789.mp4",
                    "state": "completed",
                },
            },
        ],
