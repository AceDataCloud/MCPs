"""Task query tools for Kling API."""
...
@mcp.tool()
async def kling_get_task(
    task_id: Annotated[
        str,
        Field(
            description="The task ID returned from a generation request. This is the 'task_id' field from any kling_generate_* or kling_extend_* tool response."
        ),
    ],
) -> str:
