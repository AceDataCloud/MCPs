...
from core.exceptions import DeepSeekAPIError, DeepSeekAuthError, DeepSeekTimeoutError


@pytest.fixture
def client():
    """Create a client instance for testing."""
    return DeepSeekClient(api_token="test-token", base_url="https://api.test.com")
...
class TestDeepSeekClient:
    ...
    def test_init_with_params(self):
        ...
        client = DeepSeekClient(api_token="my-token", base_url="https://custom.api.com")
    ...
    def test_get_headers_no_token(self):
        ...
        client = DeepSeekClient(api_token="", base_url="https://api.test.com")
        with pytest.raises(DeepSeekAuthError, match="not configured"):
            client._get_headers()
    ...
    async def test_request_auth_error_401(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(DeepSeekAuthError, match="Invalid API token"):
                await client.request("/deepseek/chat/completions", {})
    ...
    async def test_request_http_error(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(DeepSeekAPIError, match="Internal Server Error") as exc_info:
                await client.request("/deepseek/chat/completions", {})
    ...
    async def test_chat_completions_method(self, client, mock_chat_response):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            assert "/deepseek/chat/completions" in call_args[0][0]
