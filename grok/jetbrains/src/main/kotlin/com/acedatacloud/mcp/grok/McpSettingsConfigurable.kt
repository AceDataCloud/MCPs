...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Grok MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Documentation", "https://platform.acedata.cloud/documents/grok")
                }
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/GrokMCP")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-grok/")
                }
            }
        }
