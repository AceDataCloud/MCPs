...
@mcp.tool()
async def grok_get_task(
    task_id: Annotated[
        str,
        Field(
            description="The task ID returned from a generation request. This is the 'task_id' field from any grok_text_to_video or grok_image_to_video tool response."
        ),
    ],
) -> str:
...
@mcp.tool()
async def grok_get_tasks_batch(
    task_ids: Annotated[
        list[str],
