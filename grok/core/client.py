"""HTTP client for Grok API via AceDataCloud."""
...
class GrokClient:
    """Async HTTP client for AceDataCloud Grok API."""
    ...
    async def request(
        ...
        Args:
            endpoint: API endpoint path (e.g., "/grok/chat/completions")
    ...
    async def chat_completions(self, **kwargs: Any) -> dict[str, Any]:
        ...
        return await self.request("/grok/chat/completions", kwargs)
