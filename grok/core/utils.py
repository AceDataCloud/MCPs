"""Utility functions for MCP Grok server."""
...
def format_video_result(data: dict[str, Any]) -> str:
    ...
    """
    return json.dumps(
        _with_submission_guidance(data, "grok_get_task", "grok_get_tasks_batch"),
        ensure_ascii=False,
        indent=2,
    )
...
def format_task_result(data: dict[str, Any]) -> str:
    ...
    """
    return json.dumps(
        _with_task_guidance(data, "grok_get_task", "grok_get_tasks_batch"),
        ensure_ascii=False,
        indent=2,
    )
