...
MCP (Model Context Protocol) server for Grok API via AceDataCloud.
...
tools/
  tools/chat_tools.py  — grok_chat_completion
...
1. **Source of truth** — `_docs/openapi/grok.json` is the OpenAPI spec for the Grok API.
