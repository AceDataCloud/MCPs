#!/usr/bin/env python3
"""
MCP Grok Server - Grok API via AceDataCloud.

A Model Context Protocol (MCP) server that provides tools for interacting with
Grok models (chat completions and more) through the AceDataCloud platform.
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="MCP Grok Server - Grok API via AceDataCloud",
...
Environment Variables:
  ...
  GROK_REQUEST_TIMEOUT      Request timeout in seconds (default: 60)
  LOG_LEVEL                   Logging level (default: INFO)
    ...
    safe_print("    - grok_chat_completion")
    safe_print("    - grok_list_models")
    safe_print("    - grok_get_usage_guide")
    safe_print("")
    safe_print("=" * 50)
                ...
                return JSONResponse(
                    {
                        ...
                        "tools": [
                            {
                                "name": "grok_chat_completion",
                                "description": "Create chat completions using Grok models",
                            },
                            {
                            ...
                            {
                                "name": "grok_get_usage_guide",
                                "description": "Get Grok API usage guide",
                            },
                        ],
                        "prompts": [],
                        "resources": [],
