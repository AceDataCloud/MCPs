...
//
// Registers the hosted Ace Data Cloud "grok" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "grok.apiToken")
...
//   - acedatacloud.grok.setApiToken
//   - acedatacloud.grok.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.grok";
const SERVER_LABEL = "Grok MCP";
const SERVER_URL = "https://grok.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.grok.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.grok.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "grok.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-grok";
