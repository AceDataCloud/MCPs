...
//
// Registers the hosted Ace Data Cloud "nanobanana" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "nanobanana.apiToken")
...
//   - acedatacloud.nanobanana.setApiToken
//   - acedatacloud.nanobanana.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.nanobanana";
const SERVER_LABEL = "NanoBanana MCP";
const SERVER_URL = "https://nanobanana.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.nanobanana.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.nanobanana.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "nanobanana.apiToken";
const CREDENTIAL_URL = "https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-nanobanana";
