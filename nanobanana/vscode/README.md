...
2. **Get an API key** from [Ace Data Cloud](https://platform.acedata.cloud/console/applications?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-nanobanana) (Applications -> API Key). New accounts include free trial credit.
...
- **Ace Data Cloud platform:** https://platform.acedata.cloud/?utm_source=vscode&utm_medium=extension&utm_campaign=vscode-nanobanana
