...
from core.exceptions import KimiAPIError, KimiAuthError, KimiTimeoutError


@pytest.fixture
def client():
    """Create a client instance for testing."""
    return KimiClient(api_token="test-token", base_url="https://api.test.com")
...
class TestKimiClient:
    ...
    def test_init_with_params(self):
        ...
        client = KimiClient(api_token="my-token", base_url="https://custom.api.com")
    ...
    def test_get_headers_no_token(self):
        ...
        client = KimiClient(api_token="", base_url="https://api.test.com")
        with pytest.raises(KimiAuthError, match="not configured"):
            client._get_headers()
    ...
    async def test_request_success(self, client, mock_chat_response):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            result = await client.request(
                ...
                {"model": "kimi-k2-thinking-turbo", "messages": [{"role": "user", "content": "Hello"}]},
            )
    ...
    async def test_request_auth_error_401(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(KimiAuthError, match="Invalid API token"):
                await client.request("/kimi/chat/completions", {})
    ...
    async def test_request_timeout(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(KimiTimeoutError, match="timed out"):
                await client.request("/kimi/chat/completions", {})
    ...
    async def test_request_http_error(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            with pytest.raises(KimiAPIError, match="Internal Server Error") as exc_info:
                await client.request("/kimi/chat/completions", {})
    ...
    async def test_chat_completions_method(self, client, mock_chat_response):
        ...
        with patch("httpx.AsyncClient") as mock_http:
            ...
            assert "/kimi/chat/completions" in call_args[0][0]
