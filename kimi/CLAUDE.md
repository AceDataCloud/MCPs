...
MCP (Model Context Protocol) server for Kimi API via AceDataCloud.
...
tools/
  tools/chat_tools.py  — kimi_chat_completion
...
1. **Source of truth** — `_docs/openapi/kimi.json` is the OpenAPI spec for the Kimi API.
